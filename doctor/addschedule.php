...
//INSERT
$query = " INSERT INTO doctorschedule (  scheduleDate, scheduleDay, startTime, endTime,bookAvail,Bill)
VALUES ( '$date', '$scheduleday', '$starttime', '$endtime', '$bookavail',$bill ) ";
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:#0C4271 !important">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav" style="background-color:#343f56 !important">
                        ...
                        <li class="active">
                            <a href="addschedule.php" style="background-color:#0C4271 !important"><i class="fa fa-fw fa-table"></i> Doctor Schedule</a>
                        </li>
                        <li>
                              ...
                              <div class="row">
                               <div class="col-md-12 col-sm-12 col-xs-12">
                                <form class="form-horizontal" method="post">
                                 ...
                                 <div class="form-group form-group-lg">
                                    <label class="control-label col-sm-2 requiredField" for="bill">
                                        Payment                              
                                        <span class="asteriskField">
                                            *
                                        </span>
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="bill" name="bill" type="text" required/>
                                    </div>
                                </div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($doctorschedule=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $doctorschedule['Bill'] . "</td>";
