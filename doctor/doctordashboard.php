...
<html lang="en">
    ...
    <body>
        <div id="wrapper" style="background-color:#343f56 !important">

            <!-- Navigation -->
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:#0C4271 !important" >
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav" style="background-color:#343f56 !important">
                        <li class="active">
                            <a href="doctordashboard.php" style="background-color:#0C4271 !important"><i class="fa fa-fw fa-dashboard" ></i> Dashboard</a>
                        </li>
                        <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable" >
                       ...
                       <div class="panel-heading"style="background-color:#0C4271 !important">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                echo "<tr class='$status'>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$appointment['appId']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a> </td>";
                                    echo"<td class='text-center'><a href='#' data-toggle='modal' data-target='#myModal'>Prescribe</a></td>";
                       ...
                       echo "<button class='btn btn-primary' type='submit' value='Submit' name='submit'>Update</button>";
                        ...
                        <?php
                            ...
                            //INSERT
                            $query = " INSERT INTO patient (  Prescription )
                            VALUES ( '$Prescription' ) ";
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                                                    ...
                                                                    <input type="text" size="1000" name="Prescription" value="" class="form-control input-lg" placeholder="Prescribe"  required><textarea></textarea></input>
                                                                
                                                                
                                                                <button class="btn btn-lg btn-primary btn-block Prescription-btn" type="submit" name="Prescription" id="Prescription">Submit</button>
                                                            </form>
