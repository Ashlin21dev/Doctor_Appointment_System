...
//INSERT
$Dquery = " INSERT INTO doctor ( icDoctor,password, doctorId)
VALUES ('$icDoctor','$password','$doctorId') ";
$r = mysqli_query($con, $Dquery);
// echo $result;
if( $r )
{
?>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logo.jpg" height="40px"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><p class="navbar-text">if not already registered</p></li>
                        <li><a href="#doctorModal" data-toggle="modal" data-target="#doctorModal">Register</a></li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 col-md-6">
                                                    <input type="text" name="doctorFirstName" value="" class="form-control input-lg" placeholder="First Name" required />
                                                </div>
                                                <div class="col-xs-6 col-md-6">
                                                    <input type="text" name="doctorLastName" value="" class="form-control input-lg" placeholder="Last Name" required />
                                                </div>
                                            </div>
                                            <input type="number" name="doctorId" value="" class="form-control input-lg" placeholder="Your ID"  required/>
                                            <input type="text" name="doctorEmail" value="" class="form-control input-lg" placeholder="Your Email"  required/>
                                            <input type="number" name="icDoctor" value="" class="form-control input-lg" placeholder="Your IC Number"  required/>
                                            <input type="text" name="doctorAddress" value="" class="form-control input-lg" placeholder="Your Address"  required/>
                                            <input type="number" name="doctorPhone" value="" class="form-control input-lg" placeholder="Your Contact Number"  required/>
                                            <input type="password" name="password" value="" class="form-control input-lg" placeholder="Password"  required/>
                                            ...
                                            <button class="btn btn-lg btn-primary btn-block reg-btn" type="submit" name="reg" id="reg">Create my account</button>
                                        </form>
