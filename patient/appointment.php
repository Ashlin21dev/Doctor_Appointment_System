...
$query = "INSERT INTO appointment (  patientIc , scheduleId , appSymptom , appComment ,Bill )
VALUES ( '$patientIc', '$scheduleid', '$symptom', '$comment','$bill') ";
					...
					<div class="row">
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								<img src="assets/img/p.jpg" class="img-responsive" />
